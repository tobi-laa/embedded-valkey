...
[source,java]
----
include::https://https://raw.githubusercontent.com/tobi-laa/embedded-valkey/refs/heads/main/src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=13..16]
----
...
[source,java]
----
include::src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=27..31]
----
...
[source,java]
----
include::src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=37..42]
----
...
[source,java]
----
include::src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=47..57]
----
...
[source,java]
----
include::src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=64..74]
----
* Sharded clusters with node replication
+
[source,java]
----
include::src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=79..86]
----
