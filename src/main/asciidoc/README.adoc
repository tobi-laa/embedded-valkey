...
[source,java]
----
include::../../../src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=27..30]
----
...
[source,java]
----
include::../../../src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=34..38]
----
...
[source,java]
----
include::../../../src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=42..47]
----
...
[source,java]
----
include::../../../src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=51..62]
----
...
[source,java]
----
include::../../../src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=66..77]
----
* Sharded clusters with node replication
+
[source,java]
----
include::../../../src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=81..88]
----
...
[source,java]
----
include::../../../src/test/java/io/github/tobi/laa/embedded/valkey/examples/Examples.java[lines=92..107]
----
...
|`9.0.0`
|https://valkey.io
|https://download.valkey.io/releases/valkey-9.0.0-jammy-x86_64.tar.gz[`valkey-9.0.0-jammy-x86_64.tar.gz`]

|Linux `arm64`
|Valkey
|`9.0.0`
|https://valkey.io
|https://download.valkey.io/releases/valkey-9.0.0-jammy-arm64.tar.gz[`valkey-9.0.0-jammy-arm64.tar.gz`]

|macOS `arm64`
|Valkey
|`9.0.0`
|https://macports.org
|https://packages.macports.com/valkey/valkey-9.0.0_0.darwin_25.arm64.tbz2[`valkey-9.0.0_0.darwin_25.arm64.tbz2`]

|macOS `x86_64`
|Valkey
|`9.0.0`
|https://macports.org
|https://packages.macports.com/valkey/valkey-9.0.0_0.darwin_24.x86_64.tbz2[`valkey-9.0.0_0.darwin_24.x86_64.tbz2`]

|Windows `x86_64`
|Memurai Developer
|`4.1.7`
|https://www.nuget.org/packages
|https://www.nuget.org/api/v2/package/MemuraiDeveloper/4.1.7[`memuraideveloper.4.1.7.nupkg`]
|===
