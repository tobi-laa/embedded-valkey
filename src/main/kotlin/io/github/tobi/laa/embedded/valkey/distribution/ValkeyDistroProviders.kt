...
import io.github.tobi.laa.embedded.valkey.distribution.bundle.DEFAULT_MACPORTS_BUILD_FILE_PATHS
import io.github.tobi.laa.embedded.valkey.distribution.bundle.DEFAULT_MACPORTS_CHECKSUMS
import io.github.tobi.laa.embedded.valkey.distribution.bundle.DEFAULT_MEMURAI_VERSION
import io.github.tobi.laa.embedded.valkey.distribution.bundle.DEFAULT_VALKEY_LINUX_VERSION
import io.github.tobi.laa.embedded.valkey.distribution.bundle.DEFAULT_VALKEY_MAC_OS_VERSION
import io.github.tobi.laa.embedded.valkey.distribution.bundle.NUGET_FILE_CHECKSUMS
import io.github.tobi.laa.embedded.valkey.distribution.bundle.VALKEY_IO_FILE_CHECKSUMS
import io.github.tobi.laa.embedded.valkey.distribution.bundle.downloadLinuxDistroFromValkeyIo
import io.github.tobi.laa.embedded.valkey.distribution.bundle.downloadMacOsDistroFromMacports
import io.github.tobi.laa.embedded.valkey.distribution.bundle.downloadMemuraiDeveloperForX64FromNuget
 ...
 */
@JvmOverloads
fun downloadAndInstallLinuxDistroFromValkeyIo(
    ...
    return downloadLinuxDistroFromValkeyIo(
        proxy = proxy,
...
/**
 * Returns a [ValkeyDistributionProvider] which downloads the Valkey distribution for macOS from [MacPorts](https://www.macports.org/).
 *
 * @param proxy The proxy to use for downloading the bundle (defaults to not using a proxy).
 ...
 */
@JvmOverloads
fun downloadAndInstallMacOsDistroFromMacports(
    proxy: Proxy = Proxy.NO_PROXY,
    ...
    return downloadMacOsDistroFromMacports(
        proxy = proxy,
        operatingSystem = operatingSystem,
        valkeyVersion = valkeyVersion,
...
fun downloadAndInstallMemuraiDeveloperForX64FromNuget(
    ...
    return downloadMemuraiDeveloperForX64FromNuget(
        proxy = proxy,
...
val DEFAULT_PROVIDERS: Map<OperatingSystem, ValkeyDistributionProvider> = mapOf(
    LINUX_X86_64 to downloadAndInstallLinuxDistroFromValkeyIo(operatingSystem = LINUX_X86_64),
    LINUX_ARM64 to downloadAndInstallLinuxDistroFromValkeyIo(operatingSystem = LINUX_ARM64),
    WINDOWS_X86_64 to downloadAndInstallMemuraiDeveloperForX64FromNuget(),
    MAC_OS_X86_64 to downloadAndInstallMacOsDistroFromMacports(operatingSystem = MAC_OS_X86_64),
    MAC_OS_ARM64 to downloadAndInstallMacOsDistroFromMacports(operatingSystem = MAC_OS_ARM64),
)