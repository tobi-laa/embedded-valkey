...
class ValkeySentinel(private val distroProvider: ValkeyDistributionProvider, private val conf: ValkeyConf) : Redis {
    ...
    override fun start() {
        ...
        if (process == null) {
            process = ValkeyProcess(valkeyDistribution = distro, config = conf, sentinel = true)
        }
        process!!.start()
    }
