...
ValkeyStandalone valkey = ValkeyStandalone.builder()
        ...
        .installationSupplier(OperatingSystem.LINUX_X86_64, installValkeyIoLinuxPackageFromClasspath("/bundles/valkey-9.0.0-jammy-x86_64.tar.gz", OperatingSystem.LINUX_X86_64))
        .installationSupplier(OperatingSystem.WINDOWS_X86_64, installWinX64MemuraiPackageFromClasspath("/bundles/memuraideveloper.4.1.7.nupkg"))
        .build();
}
