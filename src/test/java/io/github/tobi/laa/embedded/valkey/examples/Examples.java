...
ValkeyStandalone valkey = ValkeyStandalone.builder()
        ...
        .installationSupplier(OperatingSystem.LINUX_X86_64, installValkeyIoLinuxPackageFromClasspath("/bundles/valkey-9.0.3-jammy-x86_64.tar.gz", OperatingSystem.LINUX_X86_64))
